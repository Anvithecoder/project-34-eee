...
function preload() {
  backgroundImg = loadImage("./assets/bankground.jpg");
}
...
function draw() {
  ...
  textAlign("center");
  textSize(40);
  text("EPIC gun Shoooting", width / 2, 100);
  ...
  textAlign("center");
  textSize(30);
  text("Remaining Bulllets : " + numberOfArrows, 200, 100);
